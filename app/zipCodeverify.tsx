...
export default function ZipCodeVerifyScreen() {
  ...
  const handleLogout = () => {
    Alert.alert('Log out?', 'You can finish ZIP verification later.', [
      ...
      >
        <View style={styles.card}>
          ...
          <Text style={styles.lead}>
            We&apos;ll ask for your name and ZIP code. We also need your agreement to our policies.
          </Text>

          <Text style={styles.leadSecondary}>
            Local List is built for <Text style={styles.em}>Harrison, AR</Text> and nearby communities. Your ZIP helps us show you
            what matters in your area.
          </Text>

          <View style={styles.callout}>
            <Text style={styles.calloutTitle}>Disclaimer (optional)</Text>
            <Text style={styles.calloutBody}>
              By allowing us to use your device location, we can suggest your ZIP based on where you are. We do not save your GPS
              coordinates, only the ZIP you confirm.
            </Text>
          </View>
          ...
          <View style={styles.disclaimerBox}>
            <Text style={styles.disclaimerText}>
              Accounts outside our approved ZIP list may be reviewed before listing or messaging. This keeps the marketplace local
              to Harrison and surrounding towns we support.
            </Text>
          </View>
